...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  The iOS portion of the wrapper for using brother printers with react native
                   DESC
  s.homepage     = "https://github.com/IvanStoilov/react-native-brother-printers"
  # brief license entry:
  s.license      = "MIT"
  ...
  s.source       = { :git => "https://github.com/IvanStoilov/react-native-brother-printers.git", :tag => "#{s.version}" }
